...
# Defina os caminhos para os seus arquivos de dados
...
# Renomeia e limpa as colunas de data
...
# Verificação de múltiplas datas de referência
...
# Cálculo dos dias de atraso e exibição de amostra
...
# Lógica de contaminação por contrato
resultados = {}
